...
echo %source2%
if exist "%~pd0\FFmpegConvertImagePng.bat" del "%~pd0\FFmpegConvertImagePng.bat"
...
set convertedfolder=%sourcemod%-Converted-Png
...
for /r %%i in (*) do (
    ...
    if not exist "%convertedfolder%\!filepath!\!outfile!.png" (
        ...
        start !wait! /MIN /I /ABOVENORMAL %~pd0\FFmpegConvertImagePng.bat "%%i" 80 "%convertedfolder%\!filepath!\!outfile!.Png"
